...
phidgets.prototype.connect = function(next) {
    ...
    self.client = net.createConnection(self.options.port, self.options.host, function() {
        ...
        self.client.write("set /PCK/Client/0.0.0.0/1/PhidgetManager=\"Open\" for session" + self.options.delimiter);
...
phidgets.prototype.quit = function() {
    ...
    self.client.write("set /PCK/Client/0.0.0.0/1/PhidgetManager=\"Closed\" for session" + self.options.delimiter);
